    ...
    <form action="/veiculos/atualizar/{{ $carro->id }}" method="POST">
        ...
        @method('PUT')
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="marca" title="marca" name="marca" placeholder="Marca do veículo" value="{{ $carro->marca }}">
            </div>
            <div class="form-group">
                <label for="title">Modelo:</label>
                <input type="text" class="form-control" id="modelo" title="modelo" name="modelo" placeholder="Modelo do veículo" value="{{ $carro->modelo }}">
            </div>
            <div class="form-group">
                <label for="title">Versão:</label>
                <input type="number" name="versao" id="versao" placeholder="Versão, exemplo: 3.0" value="{{ $carro->versao }}">
            </div>
            <div class="form-group">
                <label for="title">Placa:</label>
                <input type="text" class="form-control" id="placa" title="placa" name="placa" placeholder="Placa do veículo" value="{{ $carro->placa }}">
            </div>
